...
if __name__ == '__main__':
    # Usage:
    sender_name = 'John Huang'
    sender_addr = 'johnhuang@chenbro.com'
    smtp = 'exmail3.chenbro.com.tw'
    port = '587'
    recipient_addr = ['johnhuang@chenbro.com']
    subject = 'Python email with attachment and image'
    text = "johnhuang in chenbro"
    html = """
        <html>
        <head>
    ...
    img_list = ['1.jpg']  # -> image0, image1, image2, ...
    attachments = ['other_data.txt']

    send_email(sender_name, sender_addr, smtp, port,
               recipient_addr, subject, html, text,
               img_list, attachments, 
               fn='my.mht', 
               save=True)
